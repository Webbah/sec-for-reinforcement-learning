...
OMG_DDPG_Integrator_no_pastVals_500 = \
    pd.read_pickle(folder_name + '/OMG_DDPG_SEC_500_agents.pkl')['return'].tolist()
...
OMG_DDPG_return_798 = pd.read_pickle(folder_name + '/OMG_DDPG_agents.pkl')['return_Mean'].tolist()
...
SEC_train_data = pd.read_pickle(folder_name+'/OMG_DDPG_SEC_train_data.pkl')
DDPG_train_data = pd.read_pickle(folder_name+'/OMG_DDPG_train_data.pkl')
