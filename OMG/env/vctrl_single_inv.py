...
import numpy as np
import pandas as pd
from openmodelica_microgrid_gym.util.transforms import abc_to_dq0
...
net = Network.load('OMG/net/net_vctrl_single_inv_dq0.yaml')
...
gen = RandProcessWrapper(VasicekProcess, proc_kwargs=dict(speed=800, vol=40, mean=R), initial=R,
...
rand_load_test = RandomLoad(2881, net.ts, gen,
                             load_curve=pd.read_pickle('OMG/data/R_load_hard_test_case_10_seconds.pkl'))
