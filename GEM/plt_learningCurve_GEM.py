...
SEC = pd.read_pickle(folder_name + '/GEM_I_term_4_1250_agents_data_with_rewards.pkl')
DDPG = pd.read_pickle(folder_name + '/GEM_no_I_term_4_1250_agents_data_with_rewards.pkl')
...
SEC_train_data = pd.read_pickle(folder_name + '/GEM_I_term_4_1250_agents_train_data.pkl')
DDPG_train_data = pd.read_pickle(folder_name + '/GEM_no_I_term_4_1250_agents_train_data.pkl')
